...
| `tfyNatsUi.podSecurityContext`                          | Pod security context                                                | `{"seccompProfile":{"type":"RuntimeDefault"}}` |
| `tfyNatsUi.securityContext`                             | Container security context                                          | `{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"privileged":false,"runAsGroup":101,"runAsNonRoot":true,"runAsUser":100}` |
...
| `tfyMetricsDashboard.podSecurityContext`                          | Pod-level security context                                                                    | `{"seccompProfile":{"type":"RuntimeDefault"}}` |
| `tfyMetricsDashboard.securityContext`                             | Container-level security context                                                              | `{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"privileged":false,"runAsGroup":101,"runAsNonRoot":true,"runAsUser":100}` |
...
| `headlamp.podSecurityContext`            | Pod security context                                                                                                                                                 | `{"seccompProfile":{"type":"RuntimeDefault"}}` |
| `headlamp.securityContext`               | Container security context                                                                                                                                           | `{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"privileged":false,"runAsGroup":101,"runAsNonRoot":true,"runAsUser":100}` |
