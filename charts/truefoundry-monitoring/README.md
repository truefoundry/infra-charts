...
| `grafana.grafana.ini.auth.jwt.jwk_set_url`                      | JWKS URL (must match your global.controlPlaneURL, e.g. https://cp.example.com/api/svc/v1/keys/truefoundry/jwks) | `http://tfy-proxy:8080/api/svc/v1/keys/truefoundry/jwks` |
