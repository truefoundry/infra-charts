...
| `aws-eks-gpu-operator.dcgmExporter.resources.limits.memory`                    | Memory limit for the DCGM Exporter.                       | `300Mi`                   |
...
| `gcp-gke-standard-dcgm-exporter.resources.requests.memory`      | Memory request for the DCGM Exporter.                                | `100Mi`                                                                                                         |
...
| `azure-aks-dcgm-exporter.resources.requests.memory`      | Memory request for the DCGM Exporter.                                 | `100Mi`                                                                |
| `azure-aks-dcgm-exporter.resources.limits.cpu`           | CPU limit for the DCGM Exporter.                                      | `100m`                                                                 |
| `azure-aks-dcgm-exporter.resources.limits.memory`        | Memory limit for the DCGM Exporter.                                   | `300Mi`                                                                |
