...
| `aws-eks-gpu-operator.toolkit.version`                                         | Version of the toolkit.                                   | `v1.13.4-centos7`         |
...
| `aws-eks-gpu-operator.dcgmExporter.version`                                    | Version of the DCGM Exporter.                             | `3.1.8-3.1.5-ubuntu20.04` |
...
| Name                                                            | Description                                                        | Value                                                                                                           |
| --------------------------------------------------------------- | ------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------- |
| `gcp-gke-standard-dcgm-exporter.image.tag`                      | Docker image tag for the DCGM Exporter.                            | `3.1.8-3.1.5-ubuntu20.04`                                                                                       |
...
| Name                                                     | Description                                                           | Value                                                                  |
| -------------------------------------------------------- | --------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `azure-aks-dcgm-exporter.image.tag`                      | Docker image tag for the DCGM Exporter.                               | `3.1.8-3.1.5-ubuntu20.04`                                              |
