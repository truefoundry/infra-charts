...
| `tfyAgent.image.tag`                            | Overrides the image tag whose default is the chart appVersion.                                                        | `7452a61579c97e6b27721451a705603217fbb386` |
...
| `tfyAgent.podSecurityContext`                   | Pod-level Security Context for the tfyAgent Deployment                                                                | `{}`                                       |
...
| `tfyAgentProxy.image.tag`                                           | Image tag whose default is the chart appVersion.                                                                           | `ee2b4bf959a135adbafa3ce450358cb8fb7de556` |
