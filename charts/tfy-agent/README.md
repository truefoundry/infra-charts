...
| `tfyAgent.image.tag`                                   | Overrides the image tag whose default is the chart appVersion.                                                        | `be47383b811e2137a3638f69bfcba487f36127d7` |
...
| `tfyAgentProxy.image.repository`                     | tfyAgentProxy repository                                                                                                   | `truefoundrycloud/tfy-agent-proxy`         |
| `tfyAgentProxy.image.pullPolicy`                     | Pull policy for tfyAgentProxy                                                                                              | `IfNotPresent`                             |
| `tfyAgentProxy.image.tag`                            | Image tag whose default is the chart appVersion.                                                                           | `d4185e308b8fdf846ff6e370750da1c1d729f1a4` |
