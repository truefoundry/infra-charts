...
| `tfyAgent.image.tag`                                   | Overrides the image tag whose default is the chart appVersion.                                                        | `b7161a6296aa002cd5b364e9aacf63cb02e9f816` |
...
| `tfyAgent.livenessProbe.failureThreshold`              | Failure threshhold value for liveness probe of tfyAgent container                                                     | `20`                                       |
...
| `tfyAgent.readinessProbe.failureThreshold`             | Failure threshhold value for liveness probe of tfyAgent container                                                     | `20`                                       |
