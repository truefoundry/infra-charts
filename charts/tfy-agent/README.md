...
| `tfyAgent.image.tag`                            | Overrides the image tag whose default is the chart appVersion.                                                        | `f2dbde7bdeab561cf4ef8ce5a6ceff4c2f60fac0` |
...
| `tfyAgentProxy.image.tag`                                           | Image tag whose default is the chart appVersion.                                                                           | `f2dbde7bdeab561cf4ef8ce5a6ceff4c2f60fac0` |
