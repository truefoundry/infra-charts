...
| `config.multiLogicalClusterEnabled`      | Enable multiple logical clusters on one physical cluster                                                            | `false`                                                                |
...
| `logicalClusters`                        | Logical clusters served by this agent when config.multiLogicalClusterEnabled is true.                               | `[]`                                                                   |
