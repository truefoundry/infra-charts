...
| `tfyAgent.image.tag`                            | Overrides the image tag whose default is the chart appVersion.                                                        | `08cd97b58b41e479f06913ebdbada5bf803960dd` |
...
| `tfyAgentProxy.image.tag`                                           | Image tag whose default is the chart appVersion.                                                                           | `08cd97b58b41e479f06913ebdbada5bf803960dd` |
...
| `sdsServer.extraEnvVars`                         | Additional envrionment variables for sdsServer                                                                    | `[]`                                       |
| `sdsServer.service.annotations`                  | Annotations to add to the sdsServer service                                                                       | `{}`                                       |
| `sdsServer.service.labels`                       | Labels to add to the sdsServer service                                                                            | `{}`                                       |
...
| `sdsServer.image.tag`                            | Tag for sdsServer                                                                                                 | `81e55e99abf55ed9fa4bfdcf3b23682464dd8f5e` |
