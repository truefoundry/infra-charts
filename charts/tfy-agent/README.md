...
| `tfyAgent.resources.limits.memory`                     | Memory Resource limits for tfyAgent container. Advised to only increase the limits and not decrease it                | `6000Mi`                                   |
...
| `tfyAgent.resources.requests.memory`                   | Memory Resource requests for tfyAgent container. Advised to only increase the requests and not decrease it            | `4000Mi`                                   |
