...
| `serviceMonitors.alertManager.name`                   | Name of the service monitor               | `alert-manager`                       |
...
| `serviceMonitors.kubelet.name`                        | Name of the service monitor               | `kubelet`                             |
...
| `serviceMonitors.stateMetrics.enabled`                | Enable service monitor for state metrics  | `true`                                |
| `serviceMonitors.stateMetrics.name`                   | Name of the service monitor               | `prometheus-kube-state-metrics`       |
| `serviceMonitors.stateMetrics.labels`                 | Labels for state metrics                  | `{}`                                  |
| `serviceMonitors.stateMetrics.jobLabel`               | Job label for state metrics               | `app.kubernetes.io/name`              |
| `serviceMonitors.stateMetrics.endpoints`              | Endpoints for state metrics               | `[]`                                  |
| `serviceMonitors.stateMetrics.serviceSelectorLabels`  | Service selector labels for state metrics | `{}`                                  |
