...
| `controlPlaneMonitors.deltafusionIngestor.serviceSelectorLabels`    | Service selector labels for sfy manifest service      | `{}`                                     |
| `controlPlaneMonitors.deltafusionIngestor.namespaceSelector`        | Namespace selector for sfy manifest service           | `{}`                                     |
| `controlPlaneMonitors.deltafusionQueryServer.enabled`               | Enable service monitor for deltafusion ingestor       | `true`                                   |
| `controlPlaneMonitors.deltafusionQueryServer.name`                  | Name of the service monitor                           | `deltafusion-query-server`               |
| `controlPlaneMonitors.deltafusionQueryServer.labels`                | Labels for deltafusion ingestor                       | `{}`                                     |
| `controlPlaneMonitors.deltafusionQueryServer.annotations`           | Annotations for deltafusion ingestor                  | `{}`                                     |
| `controlPlaneMonitors.deltafusionQueryServer.endpoints`             | Endpoints for deltafusion ingestor                    | `[]`                                     |
| `controlPlaneMonitors.deltafusionQueryServer.serviceSelectorLabels` | Service selector labels for sfy manifest service      | `{}`                                     |
| `controlPlaneMonitors.deltafusionQueryServer.namespaceSelector`     | Namespace selector for sfy manifest service           | `{}`                                     |
