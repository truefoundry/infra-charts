...
| `serviceMonitors.tfyOtelCollector.jobLabel`                        | Job label for otel collector                             | `truefoundry.com/application`             |
...
| `serviceMonitors.altinityClickHouseOperator.jobLabel`              | Job label for Altinity ClickHouse operator               | `app.kubernetes.io/name`                  |
| `serviceMonitors.altinityClickHouseOperator.endpoints`             | Endpoints for Altinity ClickHouse operator               | `[]`                                      |
| `serviceMonitors.altinityClickHouseOperator.namespaceSelector`     | Namespace selector for Altinity ClickHouse operator      | `{}`                                      |
| `serviceMonitors.altinityClickHouseOperator.serviceSelectorLabels` | Service selector labels for Altinity ClickHouse operator | `{}`                                      |
