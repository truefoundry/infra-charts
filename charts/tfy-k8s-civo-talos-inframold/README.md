...
| `truefoundry.truefoundry_iam_role_arn`       | IAM role ARN used as service account annotation for TrueFoundry components when control plane installation is enabled | `""`  |
