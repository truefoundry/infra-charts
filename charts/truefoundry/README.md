...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.84.0-rc.2`                                                                              |
...
| `global.proxy.servicefoundryServerHost`                                      | Servicefoundry server host for the frontend app                                        | `{{ .Release.Name }}-servicefoundry-server.{{ .Release.Namespace }}.svc.cluster.local`     |
| `global.proxy.mlfoundryHost`                                                 | mlfoundry server host for the frontend app                                             | `{{ .Release.Name }}-mlfoundry-server.{{ .Release.Namespace }}.svc.cluster.local`          |
| `global.proxy.tfyWorkflowAdminHost`                                          | tfy workflow admin host for the frontend app                                           | `{{ .Release.Name }}-tfy-workflow-admin-server.{{ .Release.Namespace }}.svc.cluster.local` |
| `global.proxy.s3proxyHost`                                                   | s3 proxy host for the frontend app                                                     | `{{ .Release.Name }}-s3proxy.{{ .Release.Namespace }}.svc.cluster.local`                   |
| `global.proxy.tfyOtelCollectorHost`                                          | otel collector host for the frontend app                                               | `{{ .Release.Name }}-tfy-otel-collector.{{ .Release.Namespace }}.svc.cluster.local`        |
...
| `global.proxy.proxyServerHost`                                               | Proxy server host for the frontend app                                                 | `{{ .Release.Name }}-tfy-controller.{{ .Release.Namespace }}.svc.cluster.local`            |
| `global.proxy.tfyProxyHost`                                                  | tfy proxy host for the frontend app                                                    | `{{ .Release.Name }}-tfy-proxy.{{ .Release.Namespace }}.svc.cluster.local`                 |
| `global.proxy.truefoundryFrontendAppHost`                                    | truefoundry frontend app host for the frontend app                                     | `{{ .Release.Name }}-truefoundry-frontend-app.{{ .Release.Namespace }}.svc.cluster.local`  |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                                               | `v0.84.0`                                               |
...
| `tfyK8sController.image.tag`                                   | Image tag for the tfyK8sController                                               | `v0.84.0`                               |
...
| `tfyBuild.truefoundryWorkflows.sfyBuilder.image.tag`                            | Tag for the sfyBuilder                                                                    | `v0.8.18`                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `tfyBuild.truefoundryWorkflows.sociIndexBuildAndPush.image.tag`                 | Tag for the SOCI index build and push                                                     | `v0.8.18`                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `deltaFusionQueryServer.image.tag`                                   | Image tag for the deltaFusionQueryServer                                               | `v0.84.0`                                     |
...
| `tfyProxy.environmentName`                               | Environment name for tfyProxy                                            | `default`                         |
