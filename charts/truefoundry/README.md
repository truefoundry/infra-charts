...
| `global.controlPlaneChartVersion`               | Version of control-plane chart                               | `0.6.2`                                                                          |
...
| `truefoundryFrontendApp.image.tag`                            | Image tag for the frontend app                         | `v0.5.1`                                                                                   |
...
| `mlfoundryServer.image.tag`                            | Image tag for the mlfoundry server                         | `v0.4.0`                                           |
...
| `servicefoundryServer.image.tag`                            | Image tag for the servicefoundry server                         | `v0.6.1`                                                |
...
| `tfyK8sController.image.tag`                            | Image tag for the tfyK8sController                         | `v0.3.0`                                             |
...
| `sfyManifestService.image.tag`                            | Image tag for the sfy manifest service                         | `v0.3.0`                                               |
...
| `tfyBuild.truefoundryWorkflows.sfyBuilder.image.tag`                            | Tag for the sfyBuilder                                        | `v0.8.11`                                                                                 |
...
build-and-push.sh
`              |
| `tfyBuild.truefoundryWorkflows.sfyBuilder.baseImagePullSecret`                  | Base image pull secret for the sfyBuilder                     | `""`                                                                                     |
...
| `tfyController.image.tag`                  | Image tag for the tfyController                         | `v0.2.0`                                         |
...
| `tfyWorkflowAdmin.image.tag`                  | Image tag for the tfyWorkflowAdmin                         | `v0.3.0`                                             |
