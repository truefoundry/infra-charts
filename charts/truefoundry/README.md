...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.87.0-rc.1`                                                                              |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                                               | `v0.87.0`                                                                                  |
...
| `deltaFusionIngestor.image.tag`                                   | Image tag for the DeltaFusion Ingestor                                                     | `v0.87.0`                                 |
...
| `deltaFusionCompaction.image.tag`                                   | Image tag for the deltaFusionCompaction                                                     | `v0.87.0`                                 |
...
| `deltaFusionQueryServer.image.tag`                                   | Image tag for the deltaFusionQueryServer                                               | `v0.87.0`                                     |
