...
| `global.controlPlaneChartVersion`                    | Version of control-plane chart                                                         | `0.70.0-rc.1`                                                                    |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                         | `v0.70.0`                                                                                  |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                         | `v0.70.0`                                               |
...
| `tfyK8sController.image.tag`                                   | Image tag for the tfyK8sController                                       | `v0.70.0`                                            |
