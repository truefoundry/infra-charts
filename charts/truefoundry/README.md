...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `v0.85.2`                                                                                  |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                                               | `v0.85.0`                                                                                  |
...
| `mlfoundryServer.image.tag`                                   | Image tag for the mlfoundry server                                               | `v0.85.0`                             |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                                               | `v0.85.0`                                               |
...
| `tfyK8sController.image.tag`                                   | Image tag for the tfyK8sController                                               | `v0.85.0`                               |
...
| `deltaFusionIngestor.image.tag`                                   | Image tag for the DeltaFusion Ingestor                                                     | `v0.85.1`                                 |
...
| `deltaFusionCompaction.image.tag`                                   | Image tag for the deltaFusionCompaction                                                     | `v0.85.1`                                 |
...
| `deltaFusionQueryServer.image.tag`                                   | Image tag for the deltaFusionQueryServer                                               | `v0.84.1`                                     |
