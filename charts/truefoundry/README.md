...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.85.0-rc.1`                                                                              |
...
| `deltaFusionIngestor.image.tag`                                   | Image tag for the DeltaFusion Ingestor                                                     | `v0.85.0`                                 |
...
| `deltaFusionCompaction.image.tag`                                   | Image tag for the deltaFusionCompaction                                                     | `v0.85.0`                                 |
