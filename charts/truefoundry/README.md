...
| `global.controlPlaneChartVersion`                    | Version of control-plane chart                                                         | `0.66.0`                                                                         |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                         | `v0.66.0`                                                                                  |
...
| `mlfoundryServer.image.tag`                                   | Image tag for the mlfoundry server                         | `v0.66.0`                                          |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                         | `v0.66.0`                                               |
...
| `tfyK8sController.image.tag`                                   | Image tag for the tfyK8sController                                       | `v0.66.0`                                            |
...
| `tfyController.image.tag`                                   | Image tag for the tfyController                                       | `v0.66.0`                                        |
