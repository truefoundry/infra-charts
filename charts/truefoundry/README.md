...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.75.0-rc.2`                                                                    |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                         | `v0.75.0`                                                                                  |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                         | `v0.75.0`                                               |
