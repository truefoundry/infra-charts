...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.81.1`                                                                         |
...
| `global.imagePullSecrets`                                                    | Image pull secrets for all services                                                    | `[]`                                                                             |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                                               | `v0.81.0`                                                                                  |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                                               | `v0.81.0`                                               |
...
| `deltaFusionQueryServer.image.tag`                                   | Image tag for the deltaFusionQueryServer                                               | `v0.81.0`                                     |
