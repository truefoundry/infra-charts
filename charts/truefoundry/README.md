...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.86.0-rc.1`                                                                              |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                                               | `v0.86.0`                                                                                  |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                                               | `v0.86.0`                                               |
...
| `tfyK8sController.image.tag`                                   | Image tag for the tfyK8sController                                               | `v0.86.0`                               |
...
| `deltaFusionIngestor.image.tag`                                   | Image tag for the DeltaFusion Ingestor                                                     | `v0.86.0`                                 |
...
| `deltaFusionCompaction.image.tag`                                   | Image tag for the deltaFusionCompaction                                                     | `v0.86.0`                                 |
...
| `deltaFusionQueryServer.image.tag`                                   | Image tag for the deltaFusionQueryServer                                               | `v0.86.0`                                     |
