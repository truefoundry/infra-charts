...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.84.8`                                                                                   |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                                               | `v0.84.1`                                                                                  |
...
| `mlfoundryServer.image.tag`                                   | Image tag for the mlfoundry server                                               | `v0.84.0`                             |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                                               | `v0.84.3`                                               |
...
| `tfyK8sController.image.tag`                                   | Image tag for the tfyK8sController                                               | `v0.84.2`                               |
...
| `tfyController.image.tag`                                   | Image tag for the tfyController                                               | `v0.83.0`                           |
...
| `deltaFusionIngestor.image.tag`                                   | Image tag for the DeltaFusion Ingestor                                                     | `v0.84.0`                                 |
...
| `deltaFusionCompaction.image.tag`                                   | Image tag for the deltaFusionCompaction                                                     | `v0.84.0`                                 |
