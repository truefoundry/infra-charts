...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.1.5-test`                                                                     |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                                               | `v0.1.3-test`                                           |
...
| `deltaFusionIngestor.image.tag`                                   | Image tag for the DeltaFusion Ingestor                                                     | `v0.81.0`                                 |
