...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.73.1`                                                                         |
...
| `tfyBuild.truefoundryWorkflows.sociIndexBuildAndPush.image.tag`                 | Tag for the SOCI index build and push                         | `v0.8.16`                                                                                                                                                                                                                                                                                                                                                                                                                        |
