...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.88.0-rc.1`                                                                              |
...
| `global.ingress.ingressClassName`                                            | Ingress class name for the control plane                                               | `istio`                                                                                    |
...
| `global.proxy.hosts`                                                         | List of proxy hosts                                                                    | `[]`                                                                                       |
| `global.proxy.servicefoundryServerHost`                                      | Servicefoundry server host for service routing                                         | `{{ .Release.Name }}-servicefoundry-server.{{ .Release.Namespace }}.svc.cluster.local`     |
| `global.proxy.mlfoundryHost`                                                 | mlfoundry server host for service routing                                              | `{{ .Release.Name }}-mlfoundry-server.{{ .Release.Namespace }}.svc.cluster.local`          |
| `global.proxy.tfyWorkflowAdminHost`                                          | tfy workflow admin host for service routing                                            | `{{ .Release.Name }}-tfy-workflow-admin-server.{{ .Release.Namespace }}.svc.cluster.local` |
| `global.proxy.s3proxyHost`                                                   | s3 proxy host for service routing                                                      | `{{ .Release.Name }}-s3proxy.{{ .Release.Namespace }}.svc.cluster.local`                   |
| `global.proxy.tfyOtelCollectorHost`                                          | otel collector host for service routing                                                | `{{ .Release.Name }}-tfy-otel-collector.{{ .Release.Namespace }}.svc.cluster.local`        |
| `global.proxy.tfyNats.host`                                                  | nats host for nats service                                                             | `{{ .Release.Name }}-tfy-nats.{{ .Release.Namespace }}.svc.cluster.local`                  |
| `global.proxy.tfyNats.port`                                                  | nats port for nats service                                                             | `8080`                                                                                     |
| `global.proxy.llmGateway.external`                                           | Make LLMGateway external                                                               | `false`                                                                                    |
| `global.proxy.llmGateway.backendHost`                                        | Backend Host for the LLM gateway                                                       | `{{ .Release.Name }}-tfy-llm-gateway.{{ .Release.Namespace }}.svc.cluster.local`           |
| `global.proxy.llmGateway.backendPort`                                        | Backend Port for the LLM gateway                                                       | `8787`                                                                                     |
| `global.proxy.tfyOtelCollector.host`                                         | OTEL collector host for OTEL collector service                                         | `{{ .Release.Name }}-tfy-otel-collector.{{ .Release.Namespace }}.svc.cluster.local`        |
| `global.proxy.tfyOtelCollector.port`                                         | OTEL collector port for OTEL collector service                                         | `4318`                                                                                     |
| `global.proxy.proxyServerHost`                                               | Proxy server host for service routing                                                  | `{{ .Release.Name }}-tfy-controller.{{ .Release.Namespace }}.svc.cluster.local`            |
| `global.proxy.tfyProxyHost`                                                  | tfy proxy host for service routing                                                     | `{{ .Release.Name }}-tfy-proxy.{{ .Release.Namespace }}.svc.cluster.local`                 |
| `global.proxy.truefoundryFrontendAppHost`                                    | truefoundry frontend app host for service routing                                      | `{{ .Release.Name }}-truefoundry-frontend-app.{{ .Release.Namespace }}.svc.cluster.local`  |
| `global.proxy.tfyLLMAgentHost`                                               | LLM agent host for service routing                                                     | `{{ .Release.Name }}-tfy-llm-agent.{{ .Release.Namespace }}.svc.cluster.local`             |
| `global.proxy.sfyManifestServiceHost`                                        | Manifest service host for service routing                                              | `{{ .Release.Name }}-sfy-manifest-service.{{ .Release.Namespace }}.svc.cluster.local`      |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                                               | `v0.88.0`                                                                                  |
...
| `truefoundryFrontendApp.mlfoundryHost`                               | mlfoundry server host for the frontend app                                   | `{{ .Release.Name }}-mlfoundry-server.{{ .Release.Namespace }}.svc.cluster.local`          |
...
| `truefoundryFrontendApp.tfyNatsHost`                                 | nats host for the frontend app                                               | `{{ .Release.Name }}-tfy-nats.{{ .Release.Namespace }}.svc.cluster.local`                  |
...
| `mlfoundryServer.image.tag`                                   | Image tag for the mlfoundry server                                               | `v0.86.0`                             |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                                               | `v0.88.0`                                               |
...
| `tfyK8sController.image.tag`                                   | Image tag for the tfyK8sController                                               | `v0.87.0`                               |
...
| `tfyBuild.truefoundryWorkflows.sfyBuilder.image.tag`                            | Tag for the sfyBuilder                                                                    | `v0.8.19`                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `tfyBuild.truefoundryWorkflows.sociIndexBuildAndPush.image.tag`                 | Tag for the SOCI index build and push                                                     | `v0.8.19`                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `tfyController.image.tag`                                   | Image tag for the tfyController                                               | `v0.85.0`                           |
...
| `deltaFusionIngestor.image.tag`                                   | Image tag for the DeltaFusion Ingestor                                                     | `v0.88.0`                                 |
...
| `deltaFusionCompaction.image.tag`                                   | Image tag for the deltaFusionCompaction                                                     | `v0.88.0`                                 |
...
| `deltaFusionQueryServer.image.tag`                                   | Image tag for the deltaFusionQueryServer                                               | `v0.88.0`                                     |
