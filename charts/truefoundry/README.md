...
| `global.controlPlaneChartVersion`                    | Version of control-plane chart                                                         | `0.69.1`                                                                         |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                         | `v0.69.2`                                                                                  |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                         | `v0.69.1`                                               |
