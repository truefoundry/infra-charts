...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.74.1`                                                                         |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                         | `v0.74.0`                                                                                  |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                         | `v0.74.0`                                               |
...
| `tfyK8sController.image.tag`                                   | Image tag for the tfyK8sController                                       | `v0.74.0`                                            |
