...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.74.2`                                                                         |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                         | `v0.74.1`                                                                                  |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                         | `v0.74.1`                                               |
