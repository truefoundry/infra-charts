...
| `global.controlPlaneChartVersion`                                            | Version of control-plane chart                                                         | `0.76.0-rc.3`                                                                    |
...
| `truefoundryFrontendApp.image.tag`                                   | Image tag for the frontend app                         | `v0.76.0`                                                                                  |
...
| `mlfoundryServer.image.tag`                                   | Image tag for the mlfoundry server                         | `v0.76.0`                                          |
...
| `servicefoundryServer.image.tag`                                   | Image tag for the servicefoundry server                         | `v0.76.0`                                               |
...
| `tfyK8sController.image.tag`                                   | Image tag for the tfyK8sController                                       | `v0.76.0`                                            |
