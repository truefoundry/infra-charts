...
{{- $podLabels := mergeOverwrite (deepCopy .Values.global.labels) $commonLabels (deepCopy .Values.global.podLabels) .Values.sfyManifestService.podLabels $selectorLabels }}
{{- toYaml $podLabels }}
{{- end }}
