...
{{/*
Name the bundled Redis subchart gives its objects, mirroring common.names.fullname
from the Bitnami chart so the master Service name stays in sync with it.
*/}}
{{- define "truefoundry.redis.fullname" -}}
