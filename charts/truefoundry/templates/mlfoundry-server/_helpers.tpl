...
{{- if .Values.mlfoundryServer.serviceAccount.create }}
{{- default (include "mlfoundry-server.fullname" .) .Values.mlfoundryServer.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.mlfoundryServer.serviceAccount.name }}
{{- end }}
{{- end }}
