...
Common labels
*/}}
{{- define "tfy-kyverno.labels" -}}
helm.sh/chart: {{ include "tfy-kyverno.chart" . }}
{{ include "tfy-kyverno.selectorLabels" . }}
{{- if .Chart.AppVersion }}
