...
| `controlPlaneMonitors.deltafusionIngestor.enabled`                  | Enable service monitor for deltafusion ingestor              | `true`                                   |
| `controlPlaneMonitors.deltafusionIngestor.name`                     | Name of the service monitor                                  | `deltafusion-ingestor`                   |
| `controlPlaneMonitors.deltafusionIngestor.labels`                   | Labels for deltafusion ingestor                              | `{}`                                     |
| `controlPlaneMonitors.deltafusionIngestor.annotations`              | Annotations for deltafusion ingestor                         | `{}`                                     |
| `controlPlaneMonitors.deltafusionIngestor.endpoints`                | Endpoints for deltafusion ingestor                           | `[]`                                     |
| `controlPlaneMonitors.deltafusionIngestor.serviceSelectorLabels`    | Service selector labels for deltafusion ingestor service     | `{}`                                     |
| `controlPlaneMonitors.deltafusionIngestor.namespaceSelector`        | Namespace selector for deltafusion ingestor service          | `{}`                                     |
| `controlPlaneMonitors.deltafusionQueryServer.enabled`               | Enable service monitor for deltafusion query server          | `true`                                   |
| `controlPlaneMonitors.deltafusionQueryServer.name`                  | Name of the service monitor                                  | `deltafusion-query-server`               |
| `controlPlaneMonitors.deltafusionQueryServer.labels`                | Labels for deltafusion query server                          | `{}`                                     |
| `controlPlaneMonitors.deltafusionQueryServer.annotations`           | Annotations for deltafusion query server                     | `{}`                                     |
| `controlPlaneMonitors.deltafusionQueryServer.endpoints`             | Endpoints for deltafusion query server                       | `[]`                                     |
| `controlPlaneMonitors.deltafusionQueryServer.serviceSelectorLabels` | Service selector labels for deltafusion query server service | `{}`                                     |
| `controlPlaneMonitors.deltafusionQueryServer.namespaceSelector`     | Namespace selector for deltafusion query server service      | `{}`                                     |
