...
### karpenter.defaultNodePoolSpec Node pool spec for default node pool

| Name                                       | Description                                | Value       |
| ------------------------------------------ | ------------------------------------------ | ----------- |
| `karpenter.defaultNodePoolSpec.disruption` | Consolidation policy for default node pool | `undefined` |
