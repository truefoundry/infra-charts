...
| `karpenter.defaultNodePool.enabled`                              | Enable the default node pool                                  | `true`                                                                                                                                                             |
...
| `karpenter.defaultNodePool.zones`                                | Zones for the default node pool                               | `["eu-west-1a","eu-west-1b","eu-west-1c"]`                                                                                                                         |
...
| `karpenter.defaultNodePool.ec2NodeClassRefName`                  | EC2 Node Class Reference Name for the default node pool       | `default`                                                                                                                                                          |
...
| `karpenter.gpuNodePool.ec2NodeClassRefName`                      | EC2 Node Class Reference Name for the GPU node pool           | `gpu-default`                                                                                                                                                      |
...
| `karpenter.controlPlaneNodePool.ec2NodeClassRefName`             | EC2 Node Class Reference Name for the control plane node pool | `controlplane-node-template`                                                                                                                                       |
...
| `karpenter.inferentiaNodePool.ec2NodeClassRefName`               | EC2 Node Class Reference Name for the Inferentia node pool    | `inferentia-default`                                                                                                                                               |
