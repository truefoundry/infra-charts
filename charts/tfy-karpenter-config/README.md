...
In EKS Auto Mode, the chart uses the requirement key `eks.amazonaws.com/instance-category` (not `eks.amazonaws.com/instance-family`).
You can provide explicit `instanceCategories` per NodePool, or keep using `instanceFamilies` and let the chart infer categories from family names.
...
| `karpenter.defaultNodeTemplate.create`                           | Specifies if the default node class should be created.                                                                                                                                                      | `true`                       |
...
| `karpenter.defaultNodeTemplate.kmsKeyID`                         | KMS key ID for EBS volume encryption. Leave empty to use AWS default key.                                                                                                                                   | `""`                         |
...
| `karpenter.defaultNodeTemplate.enableSoci`                       | Enable SOCI for the default nodes.                                                                                                                                                                          | `false`                      |
...
| `karpenter.defaultNodePool.create`                               | Specifies if the default node pool should be created.                                                                                                                                                       | `true`                       |
...
| `karpenter.gpuDefaultNodeTemplate.kmsKeyID`                      | KMS key ID for EBS volume encryption. Leave empty to use AWS default key.                                                                                                                                   | `""`                         |
...
| `karpenter.gpuDefaultNodeTemplate.userData`                      | User data script for GPU node template. Set this to "default" to let the chart automatically decide this. Set this to "" to disable this injection. This will be used only when enableSoci is set to false. | `default`                    |
...
| `karpenter.controlPlaneNodeTemplate.kmsKeyID`                    | KMS key ID for EBS volume encryption. Leave empty to use AWS default key.                                                                                                                                   | `""`                         |
...
| `karpenter.inferentiaDefaultNodeTemplate.kmsKeyID`               | KMS key ID for EBS volume encryption. Leave empty to use AWS default key.                                                                                                                                   | `""`                         |
...
| `karpenter.critical.nodeclass.kmsKeyID`               | KMS key ID for EBS volume encryption. Leave empty to use AWS default key.              | `""`                    |
