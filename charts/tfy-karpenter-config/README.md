...
| `karpenter.defaultNodePool.capacityTypes`                        | Capacity types for the default node pool                      | `["spot","on-demand"]`                                                                                                                                                                    |
...
| `karpenter.defaultNodePool.instanceFamilies.notAllowed`          | Not allowed instance families for the default node pool       | `["t3","t2","t3a","p2","p3","p4d","p4de","p5","g4dn","g4ad","g5","g6","gr6","c1","cc1","cc2","cg1","cg2","cr1","g1","g2","hi1","hs1","m1","m2","m3","g4ad","inf1","inf2","trn1","trn1n"]` |
...
| `karpenter.gpuNodePool.instanceFamilies.allowed`                 | Allowed instance families for the GPU node pool               | `["p2","p3","p4d","p4de","p5","g4dn","g5","g6"]`                                                                                                                                          |
...
| `karpenter.controlPlaneNodePool.instanceFamilies.notAllowed`     | Not allowed instance families for the control plane node pool | `["t3","t2","t3a","p2","p3","p4d","p4de","p5","g4dn","g4ad","g5","g6","gr6","inf1","inf2","trn1","trn1n","c1","cc1","cc2","cg1","cg2","cr1","g1","g2","hi1","hs1","m1","m2","m3"]`        |
...
| `karpenter.inferentiaDefaultNodeTemplate.enabled`                | Enable the inferentia node pool                               | `true`                                                                                                                                                                                    |
...
| `karpenter.inferentiaNodePool.enabled`                           | Enable the Inferentia node pool                               | `true`                                                                                                                                                                                    |
