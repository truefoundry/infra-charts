...
| `flyte-core.configmap.core.propeller.leader-election.enabled`                                  | to enable leader election                                                                         | `true`                                                                       |
| `flyte-core.configmap.core.propeller.leader-election.retry-period`                             | to set the retry period                                                                           | `2s`                                                                         |
| `flyte-core.configmap.core.propeller.leader-election.lease-duration`                           | to set the lease duration                                                                         | `15s`                                                                        |
| `flyte-core.configmap.core.propeller.leader-election.renew-deadline`                           | to set the renew deadline                                                                         | `10s`                                                                        |
| `flyte-core.configmap.core.propeller.leader-election.lock-config-map.name`                     | to set the name of the lock config map                                                            | `propeller-leader`                                                           |
| `flyte-core.configmap.core.propeller.leader-election.lock-config-map.namespace`                | to set the namespace of the lock config map                                                       | `tfy-workflow-propeller`                                                     |
...
| `flyte-core.configmap.logger.level`                                                            | to set the level                                                                                  | `5`                                                                          |
| `flyte-core.configmap.logger.show-source`                                                      | to set the show source                                                                            | `true`                                                                       |
...
| `tfySignedURLServer.env`                                  | to set the environment variables              | `{}`                                            |
