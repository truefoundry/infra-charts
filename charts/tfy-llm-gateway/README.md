...
| `global.llmGatewayInfra.enabled`                | Bool if llm gateway infra is enabled        | `true`                                                         |
| `global.llmGatewayInfra.releaseName`            | Release name for the tfy-llm-gateway-infra  | `tfy-llm-gateway-infra`                                        |
| `global.llmGatewayInfra.natsAdminPassword`      | NATS admin password                         | `${k8s-secret/tfy-llm-gateway-infra-auth/NATS_ADMIN_PASSWORD}` |
